...
trtexec --onnx=model.onnx --saveEngine=model.plan --explicitBatch --minShapes=input:1x3x512x512 --optShapes=input:16x3x512x512 --maxShapes=input:32x3x512x512 --fp16 --verbose | tee conversion.txt
